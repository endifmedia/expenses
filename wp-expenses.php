 ...
 */
function activate_wp_expenses() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-activator.php';
	Wp_Expenses_Activator::activate();
}

register_activation_hook( __FILE__, 'activate_wp_expenses' );
 ...
 * @since    1.0.0
 */
function run_wp_expenses() {

	$plugin = new Wp_Expenses();
